 ...
 * Date: 2024/1/28
 * Description: This program is to measure the time taken for integer matrix multiplication(Change algorithm version).
 */

import java.util.Random;

public class ChangeAlgoIntMatrixMultiplication {
